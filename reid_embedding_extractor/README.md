...
SOLIDER_REID 모델을 사용하여 사람 이미지에서 ReID(Re-identification) 임베딩을 추출하는 최적화된 도구입니다. **SOLIDER_REID 의존성을 완전히 제거**하고 독립적으로 작동합니다. PyTorch 2.0+ 버전과 완전히 호환됩니다.

## 🚀 주요 기능

- **완전한 독립성**: SOLIDER_REID 의존성 제거, 단독 실행 가능
...
- **내장 모델 지원**: Swin Transformer (Base, Tiny, Small) 백본 지원
